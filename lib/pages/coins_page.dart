    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("COINS", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, fontFamily: 'Lucida'),
            ),
              ...
              //  :
               child: ListView.builder(
                ...
                //  print('index ${index}, ${isEvenRow}');
                  ...
                  return Container(
                    color: isEvenRow ?  const Color.fromARGB(255, 245, 245, 245):const Color.fromARGB(255, 228, 228, 228) ,
